---
type: raw-source
source_id: src-2026-08-18-alireza-diri-aiml-interviews-harmful-content
title: AIML Interviews - Harmful Content Detection
author: Alireza Diri
url: https://github.com/alirezadir/AIMLInterviews/blob/main/src/MLSD/mlsd-harmful-content.md
captured: 2026-08-18
status: immutable
tags:
  - source/raw
...
- Main actors for which data is available:
	- Users
		- user\_id, age, gender, location, contact
		- Items(Posts)
		- post\_id, author\_id, text context, images, videos, links, timestamp
		- User-post interactions
		- user\_id, post\_id, interaction\_type, value, timestamp
