...
title: AIML Interviews - ML Fundamentals
author: Alireza Diri
url: https://github.com/alirezadir/AIMLInterviews/blob/main/src/ml-fundamental.md
captured: 2026-08-18
status: immutable
tags:
  - source/raw
...
> The biggest shift in 2026 ML interviews: LLMs / foundation models are now expected **breadth**, not a specialty. Below are the core concepts interviewers probe. For end-to-end GenAI **system design** (RAG, agents, serving), see [Chapter 4](https://github.com/alirezadir/AIMLInterviews/blob/main/src/MLSD/ml-system-design.md) and the [Agentic AI Systems repo](https://github.com/alirezadir/Agentic-AI-Systems.git).
