---
type: raw-source
source_id: src-2026-08-18-alireza-diri-aiml-interviews-people-you-may-know
title: AIML Interviews - People You May Know
author: Alireza Diri
url: https://github.com/alirezadir/AIMLInterviews/blob/main/src/MLSD/mlsd-pymk.md
captured: 2026-08-18
status: immutable
tags:
  - source/raw
...
- ML Formulation:
	- Objective:
		...
		- Ranking problem:
			- pointwise LTR - binary classifier (user\_i, user\_j) -> p(connection)
