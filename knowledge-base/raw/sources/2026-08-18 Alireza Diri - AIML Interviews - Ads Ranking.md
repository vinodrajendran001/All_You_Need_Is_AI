---
type: raw-source
source_id: src-2026-08-18-alireza-diri-aiml-interviews-ads-ranking
title: AIML Interviews - Ads Ranking
author: Alireza Diri
url: https://github.com/alirezadir/AIMLInterviews/blob/main/src/MLSD/mlsd-ads-ranking.md
captured: 2026-08-18
status: immutable
tags:
  - source/raw
...
- Model selection
	- LR
		...
		- embedding based model, improves LR by automatically learning feature interactions (by learning embeddings for features)
				- w0 + \\sum (w\_i.x\_i) + \\sum\\sum <v\_i, v\_j> x\_i.x\_j
