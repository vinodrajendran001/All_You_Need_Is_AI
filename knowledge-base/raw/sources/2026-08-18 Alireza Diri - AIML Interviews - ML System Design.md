---
type: raw-source
source_id: src-2026-08-18-alireza-diri-aiml-interviews-ml-system-design
title: AIML Interviews - ML System Design
author: Alireza Diri
url: https://github.com/alirezadir/AIMLInterviews/blob/main/src/MLSD/ml-system-design.md
captured: 2026-08-18
status: immutable
tags:
  - source/raw
...
[![](https://github.com/alirezadir/AIMLInterviews/raw/main/src/imgs/components.png)](https://github.com/alirezadir/AIMLInterviews/blob/main/src/imgs/components.png)
...
- Model selection (MVP)
	- Heuristics -> simple model -> more complex model -> ensemble of models
		...
		- Complexity of the task
				...
				- Continual learning
				- Interpretability
		- [Popular NN architectures](https://github.com/alirezadir/AIMLInterviews/blob/main/src/MLSD/mlsd-modeling-popular-archs.md)
- Dataset
	- Sampling
	...
	- Scaling general SW system (distributed servers, load balancer, sharding, replication, caching, etc)
		...
		- Distributed ML
			- Data parallelism (for training)
				...
				- Asynchronous SGD
								- Synchronous SGD
				- [Distributed training](https://github.com/alirezadir/AIMLInterviews/blob/main/src/MLSD)
...
- **[Video/Movie recommendation](https://github.com/alirezadir/AIMLInterviews/blob/main/src/MLSD/mlsd-video-recom.md)** (Netflix, Youtube)
- **[Friends / follower recommendation](https://github.com/alirezadir/AIMLInterviews/blob/main/src/MLSD/mlsd-pymk.md)** (Facebook, Twitter, LinkedIn)
- **[Event recommendation system](https://github.com/alirezadir/AIMLInterviews/blob/main/src/MLSD/mlsd-event-recom.md)** (Eventbrite)
- **[Game recommendation](https://github.com/alirezadir/AIMLInterviews/blob/main/src/MLSD/mlsd-game-recom.md)**
...
- **Document search**
	- **[Text query search](https://github.com/alirezadir/AIMLInterviews/blob/main/src/MLSD/mlsd-search.md)** (full text, semantic),
		- **[Image/Video search](https://github.com/alirezadir/AIMLInterviews/blob/main/src/MLSD/mlsd-image-search.md)**,
		- **[Multimodal search](https://github.com/alirezadir/AIMLInterviews/blob/main/src/MLSD/mlsd-mm-video-search.md)** (MM Query)

### Ranking systems

- **[Newsfeed system](https://github.com/alirezadir/AIMLInterviews/blob/main/src/MLSD/mlsd-newsfeed.md)** (ranking)
- **Ads serving system** (retrieval, ranking)
	- **[Ads click prediction](https://github.com/alirezadir/AIMLInterviews/blob/main/src/MLSD/mlsd-ads-ranking.md)** (ranking)
...
- **Self-driving car**
	- Perception, Prediction, and Planning
		- [Pedestrian jaywalking detection](https://github.com/alirezadir/AIMLInterviews/blob/main/src/MLSD/mlsd-av.md)
...
- **Harmful content / Spam detection system**
	- [Multimodal harmful content detection](https://github.com/alirezadir/AIMLInterviews/blob/main/src/MLSD/mlsd-harmful-content.md)
...
Once you learn about the basics, I highly recommend checking out different companies blogs on ML systems. You can refer to some of those resources in the [ML at Companies](https://github.com/alirezadir/AIMLInterviews/blob/main/src/MLSD/ml-companies.md) section.