---
type: raw-source
source_id: src-2026-08-18-alireza-diri-aiml-interviews-multimodal-video-search
title: AIML Interviews - Multimodal Video Search
author: Alireza Diri
url: https://github.com/alirezadir/AIMLInterviews/blob/main/src/MLSD/mlsd-mm-video-search.md
captured: 2026-08-18
status: immutable
tags:
  - source/raw
...
- Data: sources and availability
	- Sources: videos (1B), text
		- 10M pairs of <video, text\_query>. Videos have metadata (title, description, tags) in text format
- Assumptions
- ML formulation:
...
- Visual search system
	- Text query -> videos (based on similarity of text and visual content)
		- Two tower embedding architecture (video and text\_query encoders)
...
We use provided annotated data in the format of <video\_id, query>.
