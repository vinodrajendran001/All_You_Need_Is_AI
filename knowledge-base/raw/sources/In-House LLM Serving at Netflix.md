...
created: 2026-07-21
description: "In-House LLM Serving at Netflix By AI Platform’s Model Runtime team and Inference team Introduction Most organizations consume LLMs through hosted APIs. Netflix went further — we run the full …"
tags:
  - "clippings"
---
## Introduction
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*GKGOrp0xddZwHomMhiSeCA.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*KuTzU3O2pm6A4HrUog1c5Q.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*xqPCzoPySS31VGUnJC0Igg.png)
