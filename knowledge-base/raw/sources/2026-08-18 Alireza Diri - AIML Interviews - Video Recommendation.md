---
type: raw-source
source_id: src-2026-08-18-alireza-diri-aiml-interviews-video-recommendation
title: AIML Interviews - Video Recommendation
author: Alireza Diri
url: https://github.com/alirezadir/AIMLInterviews/blob/main/src/MLSD/mlsd-video-recom.md
captured: 2026-08-18
status: immutable
tags:
  - source/raw
...
- I/O: I: user\_id, O: ranked list of videos + relevance score
...
2. videos (structures, metadata, video content - what is it?)
	- video\_id, title, date, rating, expected\_length?, #reviews, language, tags, description, price, developer, publisher, level, #levels
3. User-video interactions:  
	Historical interactions: Play, purchase, like, and search history, etc
	- User\_id, video\_id, timestamp, interaction\_type(purchase, play, like, impression, search), interaction\_val, location
...
- Categorical data (video\_id, user\_id, language, city): Use embedding layers, learned during training
