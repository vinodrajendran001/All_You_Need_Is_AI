---
type: raw-source
source_id: src-2026-08-18-alireza-diri-aiml-interviews-event-recommendation
title: AIML Interviews - Event Recommendation
author: Alireza Diri
url: https://github.com/alirezadir/AIMLInterviews/blob/main/src/MLSD/mlsd-event-recom.md
captured: 2026-08-18
status: immutable
tags:
  - source/raw
...
- ML formulation
	- ML Objective: Recommend most relevant (define) events to the users to maximize the number of registered events
		...
		- I/O: In: user\_id, Out: ranked list of events + relevance score
		- Pointwise LTR classifier I/O: I: <user\_id, event\_id>, O: P(event register) (Binary classification)
